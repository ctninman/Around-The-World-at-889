    ...
    <div onClick={() => setRevealCapital(!revealCapital)} className='capital_card'>
      {revealCapital 
        ...
        <div style ={{display: 'flex', justifyContent: 'center', height: '120px', width: '150px', borderRadius: '5px', color: 'darkblue'}}>
          <div className='show-capital' style={{backgroundColor: '#1F419B', color: 'white', height: '75px', borderRadius: '5px', width: '150px', wordWrap: 'break-word', alignItems: 'center', border: '2px solid', borderColor: 'white'}}>
